  ...
  <section class="p-t-60 p-b-20">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="copyright">
                                <p>Copyright &copy; <script>document.write(new Date().getFullYear());</script> Zibran. All rights reserved. Template by <a href="https://colorlib.com">Colorlib</a>. | Repost by <a href='' title='Muhamad Alfan' target='_blank'>Muhamad Alfan</a>
                                </p>
                            </div>
                        </div>
                    </div>
